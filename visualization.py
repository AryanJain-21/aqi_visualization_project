...
state_avg_1980 = state_avg_aqi[state_avg_aqi["Year"] == 1980].sort_values(
...
filtered_states = state_avg_aqi[
    state_avg_aqi["State Name"].isin(pd.concat([top_5_states, bottom_5_states]))
]
...
region_category_1980 = (
    combined_aqi[combined_aqi["Year"] == 1980]
    .groupby(["Region", "Category"])
    .size()
    .unstack(fill_value=0)
)
region_category_2021 = (
    combined_aqi[combined_aqi["Year"] == 2021]
    .groupby(["Region", "Category"])
    .size()
    .unstack(fill_value=0)
)
...
region_category_1980.plot(
    kind="bar", stacked=True, colormap="viridis", edgecolor="black", ax=ax[0]
)
...
region_category_2021.plot(
    kind="bar", stacked=True, colormap="viridis", edgecolor="black", ax=ax[1]
)
...
bubble_1980 = (
    combined_aqi[combined_aqi["Year"] == 1980]
    .groupby("State Name")
    .agg({"Number of Sites Reporting": "sum", "AQI": "mean", "State Name": "count"})
